...
export class RockAnimationManager extends BaseAnimationManager {
    ...
    private animationPaths = {
        [RockAnimationState.IDLE]: "resources/images/ANI/rock/idle.atlas",
        [RockAnimationState.ATTACKING]: "resources/images/ANI/rock/attacking.atlas",
        [RockAnimationState.WALKING]: "resources/images/ANI/rock/walking.atlas",
        [RockAnimationState.DYING]: "resources/images/ANI/rock/dying.atlas"
    };
    ...
    constructor() {
        ...
        // 从配置中获取图集尺寸
        const config = MonsterDisplayConfig.getMonsterAtlasConfig("Rock");
        if (config) {
